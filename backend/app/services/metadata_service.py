...
class MetadataService:
    ...
    async def role(self, name: str) -> RoleDetailResponse:
    ...
    async def raw_metadata(self, name: str) -> bytes:
        ...
        the bytes that passed that check are the ones returned. Either way
        the reader sees the document this service described, not a later
        fetch nobody looked at.
        """
        view = await self.view()
